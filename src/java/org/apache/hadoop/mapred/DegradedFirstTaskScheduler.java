 ...
 * by default).
 */
class DegradedFirstTaskScheduler extends TaskScheduler {
  
  private static final int MIN_CLUSTER_SIZE_FOR_PADDING = 3;
  public static final Log LOG = LogFactory.getLog(DegradedFirstTaskScheduler.class);
  ...
  public DegradedFirstTaskScheduler() {
  ...
  public synchronized List<Task> assignTasks(TaskTracker taskTracker)
    ...
    boolean assignedDegraded = false;
    scheduleMaps:
